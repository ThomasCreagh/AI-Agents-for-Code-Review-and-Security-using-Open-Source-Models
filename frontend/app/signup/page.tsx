    ...
    <div className="min-h-screen bg-white flex flex-col justify-center">
      <div className="relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-16 relative z-10">
          <div className="max-w-md mx-auto bg-white p-8 border border-[#e0e0e0] shadow-lg animate-fade-in">
            <div className="text-center mb-8">
              <h1 className="text-3xl font-semibold text-[#161616] mb-2">Create Account</h1>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-6">
                <label htmlFor="confirmPassword" className="block text-sm font-medium text-[#393939] mb-2">
                  Confirm Password
                </label>
                <input
                  id="confirmPassword"
