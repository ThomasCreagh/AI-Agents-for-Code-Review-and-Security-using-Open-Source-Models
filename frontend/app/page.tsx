      ...
      <div className="bg-[#f4f4f4] py-16 relative overflow-hidden animate-fade-in-delayed">
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h2 className="text-3xl font-semibold text-[#161616] mb-4">About This Project</h2>
            <p className="text-[#393939] mb-6">
              This AI Code Review & Security project was developed as part of the TCD Software Engineering program. It
              aims to demonstrate how artificial intelligence can be leveraged to improve code quality and security.
            </p>
            <button
              onClick={aboutUs}
