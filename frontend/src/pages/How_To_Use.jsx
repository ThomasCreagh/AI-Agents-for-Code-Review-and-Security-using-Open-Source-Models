  ...
  return (
    <div className="container">
      ...
      <div className="text-section">
        ...
        <p>3. (Optional) Enter a brief description of the error your having</p>
        <p>4. State the programming language that used by the code in the file you uploaded</p>
        <p>5. Finally click on "Upload" and the AI will respond to your request</p>
        </div>
