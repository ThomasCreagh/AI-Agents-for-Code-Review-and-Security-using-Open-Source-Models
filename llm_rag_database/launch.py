...
from model_management.config import DEFAULT_REASONING_MODEL, DEFAULT_TOOL_MODEL
import os
import logging
...
def switch_models(reasoning_model: str = None, tool_model: str = None):
    ...
    if reasoning_model:
        ...
        if model_switch:
            ...
            reasoning_model_instance = get_model(model_manager.current_reasoning_model)
            global reasoner
            reasoner = CodeAgent(
                tools=[], 
