...
import logging
from .config import MODEL_CONFIGS, ERROR_MESSAGES, DEFAULT_REASONING_MODEL, DEFAULT_TOOL_MODEL
...
class ModelManager:
    ...
    def switch_reasoning_model(self, model_name: str) -> bool:
        ...
        if model_name not in MODEL_CONFIGS:
            self.logger.error(ERROR_MESSAGES["model_not_found"].format(model_name=model_name))
            return False
